...
ARG go_target=github.com/omakoto/hl2/
...
RUN go get -v -t github.com/golang/lint/golint honnef.co/go/tools/cmd/megacheck $go_target/src/cmd/hl github.com/stretchr/testify/assert
RUN go install $go_target/src/cmd/hl
